...
package io.kamax.vbox6_1.setting.snapshot;
...
import io.kamax.vbox.settings.snapshot.SnapshotHasChildren;
import io.kamax.vbox6_1.setting._SnapshotSettingAction;
import org.virtualbox_6_1.ISnapshot;
import org.virtualbox_6_1.LockType;

public class SnapshotHasChildrenSettingAction implements _SnapshotSettingAction {
    ...
    public String getSettingName() {
        return SnapshotAttribute.HasChildren.getId();
    }
    ...
    public _Setting get(ISnapshot snap) {
        return new SnapshotHasChildren(!snap.getChildren().isEmpty());
    }
