...
import io.kamax.vbox6_1.data.Mappings;
import io.kamax.vbox6_1.factory.OsTypeFactory;
import io.kamax.vbox6_1.host.VBoxHost;
import io.kamax.vbox6_1.manager.VBoxSessionManager;
import io.kamax.vbox6_1.net.VBoxBridgedAdaptor;
import io.kamax.vbox6_1.net.VBoxHostOnlyAdaptor;
import io.kamax.vbox6_1.net.VBoxNatNetworkAdaptor;
import io.kamax.vbox6_1.service.EventsManagementService;
import io.kamax.vbox6_1.storage.VBoxMedium;
import io.kamax.vbox6_1.storage.VBoxStorageControllerSubType;
import io.kamax.vbox6_1.storage.VBoxStorageControllerType;
import io.kamax.vbox6_1.vm.VBoxMachine;
...
public abstract class VBoxHypervisor implements _Hypervisor {
    ...
    public void configure(List<_Setting> listIo) {
        for (_Setting setting : listIo) {
            Logger.debug("Handling setting: " + setting.getName());
            if (setting.getName().equalsIgnoreCase("vbox.global.machineFolder")) {
                Logger.debug("Setting default Machine Folder to :" + setting.getString());
